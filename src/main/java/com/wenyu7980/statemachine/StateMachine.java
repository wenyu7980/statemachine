 ...
 * @date:2019/12/26
 */
public class StateMachine<T, S extends StateContainer, E> {
    private String name;
    /** 状态机列表 */
     ...
     * @return
     */
    public StateMachine<T, S, E> addStateMachineTransform(S source, E event,
            S target, StateMachineGuard<T, S, E> guard) {
        this.machineContainers
                .add(new StateMachine.MachineContainer<>(source, event, target,
                        guard));
        return this;
    }
     ...
     * @return
     */
    public StateMachine<T, S, E> addEventListener(
            StateMachineEventListener<T, S, E>... listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addEventListeners(
            Collection<StateMachineEventListener<T, S, E>> listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addStateListener(
            StateMachineStateListener<T, S, E>... listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addStateListeners(
            Collection<StateMachineStateListener<T, S, E>> listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addListener(
            StateMachineListener<T, S, E>... listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addListeners(
            Collection<StateMachineListener<T, S, E>> listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addTransformListener(
            StateMachineTransformListener<T, S, E>... listeners) {
     ...
     * @return
     */
    public StateMachine<T, S, E> addTransformListeners(
    ...
    public S sendEvent(final T t, final S state, final E event,
        ...
        this.eventListeners.stream()
                ...
                .forEach(listener -> listener
                        .listener(t, state, event, context));
        // 状态迁移路径匹配
    ...
    protected static class MachineContainer<T, S extends StateContainer, E> {
        ...
        public MachineContainer(S source, E event, S target,
        ...
        public boolean match(T t, S source, E event, Object object) {
            return this.source.match(source) && Objects
                    .equals(this.event, event) && (this.guard == null
                    || this.guard.guard(t, source, event, object));
        }
